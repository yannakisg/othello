...
/**
  * Constructor of History Dialog
  */
HistoryDialog::HistoryDialog(const QString &playerName, QWidget *parent) :QDialog(parent) {
    resize(340, 229);
    ...
    setWindowTitle("Othello FPG - Score History");
